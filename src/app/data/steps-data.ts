...
export const STEPS: Step[]= [
    new Step('00', 'Welcome', 'Let\'s get started', [], true, 'icons/step-idle/00.svg', 'icons/step-active/00.svg', true, false, ['TextInputComponent']),
    ...
    new Step('03', 'Color', 'Hex codes', [], true, 'icons/step-idle/03.svg', 'icons/step-active/03.svg', false, false, ['TextInputComponent', 'TextInputComponent']),
